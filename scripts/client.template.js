...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const THEME_TOGGLE_CSS = [
      // Round toggle button styled to match the theme's ice-glass controls.
      // Uses currentColor for the icon so it follows label tokens in both modes.
      '.uiskin-theme-toggle { box-sizing: border-box; width: 32px; height: 32px; flex: none; display: inline-flex; align-items: center; justify-content: center; border-radius: 50%; border: 1px solid var(--dsw-alias-border-l2); background: var(--dsw-alias-bg-layer-2); color: var(--dsw-alias-label-secondary); cursor: pointer; padding: 0; transition: background-color 0.15s ease, color 0.15s ease, border-color 0.15s ease, box-shadow 0.15s ease; }',
      '.uiskin-theme-toggle:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover); color: var(--dsw-alias-label-primary); border-color: var(--dsw-alias-border-l2); }',
      '.uiskin-theme-toggle:focus-visible { outline: 2px solid rgba(90, 145, 205, 0.65); outline-offset: 2px; }',
      '.uiskin-theme-toggle svg { width: 16px; height: 16px; display: block; }',
    ].join('\n')
    ...
    function SunIcon() {
      return React.createElement('svg', {
        ...
        React.createElement('line', { x1: '4.93', y1: '4.93', x2: '6.34', y2: '6.34' }),
        React.createElement('line', { x1: '17.66', y1: '17.66', x2: '19.07', y2: '19.07' }),
        React.createElement('line', { x1: '2', y1: '12', x2: '4', y2: '12' }),
        React.createElement('line', { x1: '20', y1: '12', x2: '22', y2: '12' }),
        React.createElement('line', { x1: '4.93', y1: '19.07', x2: '6.34', y2: '17.66' }),
        React.createElement('line', { x1: '17.66', y1: '6.34', x2: '19.07', y2: '4.93' })
      )
    }
